...
var moduleMap = { "Extension": () => {
	dynamicLoadingCss(["style-D31ZCtX9.css"], false, "Extension");
	return __federation_import("./__federation_expose_Extension-D_RT_QMj.js").then((module) => Object.keys(module).every((item) => exportSet.has(item)) ? () => module.default : () => module);
} };
var seen = {};
