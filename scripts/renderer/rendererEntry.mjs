...
var moduleMap = { "Extension": () => {
	dynamicLoadingCss(["style-getJNPgH.css"], false, "Extension");
	return __federation_import("./__federation_expose_Extension-BaoOQN8I.js").then((module) => Object.keys(module).every((item) => exportSet.has(item)) ? () => module.default : () => module);
} };
var seen = {};
