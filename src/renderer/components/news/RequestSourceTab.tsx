    ...
    <div className="flex-1 flex flex-col p-6 overflow-hidden max-w-xl mx-auto justify-center">
      <div className="bg-surface p-6 rounded-3xl flex flex-col">
        ...
        <form onSubmit={handleSubmitRequest} className="flex flex-col gap-4 mt-4">
          <TextField value={reqName} variant="secondary" onChange={setReqName} fullWidth>
            <InputGroup>
              <InputGroup.Input placeholder="Source Name (e.g. AI News Daily)" />
            </InputGroup>
          </TextField>

          <TextField value={reqUrl} variant="secondary" onChange={setReqUrl} fullWidth>
            <InputGroup>
              <InputGroup.Input placeholder="Website URL or YouTube channel handle" />
            </InputGroup>
          </TextField>

          <TextField value={reqReason} variant="secondary" onChange={setReqReason} fullWidth>
            <InputGroup>
